	...
	<!--					<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Extensions</div> <i class="icon-menu" title="Extensions"></i></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Informacion</span> - De Trabajadores</h4>
		...
		<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						 <code>Informacion</code>Historia De Trabajadores <strong>Trabajadores De Pemex!!.</strong>
					</div>
					...
					<table class="table datatable-basic">
						...
						<tbody>
							...
							<tr>
								<td>Ezer</td>
								<td><a href="#">Gozalez</a></td>
								<td>Despachador</td>
								<td>29</td>
								<td>Ezer@gmail.com</td>
								<td>Col. Adelitas</td>
								<td><span class="badge badge-secondary">Inactive</span></td>
								<td class="text-center">
									<div class="list-icons">
							...
							<tr>
								<td>Cicely</td>
								<td>Sigler</td>
								<td><a href="#">Sin Ocupacion</a></td>
								<td>28</td>
								<td>Cicely@gmail.com</td>
								<td>Col. Adelitas</td>
								<td><span class="badge badge-info">Pending</span></td>
								<td class="text-center">
									<div class="list-icons">
